...
export const Portfolio = () => {
    return <section data-id="portfolio" className="animatedSection">
                ...
                <div className="col-xs-12 col-sm-12">
                    <div className="portfolio-content">
                        ...
                        <ul className="portfolio-filters">
                            ...
                            <li>
                                <a className="filter btn btn-sm btn-link"
                                   data-group="category_soundcloud">SoundCloud</a>
                            </li>
                            <li>
                                <a className="filter btn btn-sm btn-link" data-group="category_vimeo-videos">Vimeo
                                    Videos</a>
                            </li>
                            <li>
                                <a className="filter btn btn-sm btn-link" data-group="category_youtube-videos">YouTube
                                    Videos</a>
                            </li>
                        </ul>


                        <div className={cn("portfolio-grid", "three-columns")}>
