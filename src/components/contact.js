...
export const Contact = () => {
    return <section data-id="contact" className="animatedSection">
            ...
            <div className="row">
                <div className="col-xs-12 col-sm-4">
                    ...
                    <div className="lm-info-block gray-default">
                        ...
                        <h4><a href="https://lmpixels.com/cdn-cgi/l/email-protection" className="__cf_email__"
                               data-cfemail="51303d3429113429303c213d347f323e3c">[email&#160;protected]</a></h4>
                        <span className="lm-info-block-value"></span>
                        <span className="lm-info-block-text"></span>
                    </div>
                                ...
                                <div className="left-column">
                                    ...
                                    <div className="form-group form-group-with-icon">
                                        <input id="form_email" type="email" name="email" className="form-control"
                                               placeholder="" required="required" data-error="Valid email is required."/>
