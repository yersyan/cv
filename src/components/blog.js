...
export const Blog = () => {
    return <section data-id="blog" className="animatedSection">
                        ...
                        <div className="item post-2">
                            <div className="blog-card">
                                ...
                                <div className="post-info">
                                    ...
                                    <a href="blog-post-1.html">
                                        <h4 className="blog-item-title">Best Practices for Animated Progress
                                            Indicators</h4>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="item post-1">
                            <div className="blog-card">
                                ...
                                <div className="post-info">
                                    ...
                                    <a href="blog-post-1.html">
                                        <h4 className="blog-item-title">Designing the Perfect Feature Comparison
                                            Table</h4>
                                    </a>
                                </div>
                            </div>
